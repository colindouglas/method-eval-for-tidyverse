...
table_a1 <- tibble(
  ...
  `Blank 2` = c( 1.0,  2.9, 4.9, 8.0, 6.9, 5.0,  3.5,  1.2, 6.5, 5.6, -2.2,  2.3),
...
table_a3 <- tibble(
  ...
  `Blank 4` = c(4.0, 11.5,  4.5, 3.6, 4.4, 6.8, 8.1, 4.2, 3.7,  3.7, 5.3,  4.5),
...
stopifnot(near(limits$LoB, c(7.6, 9.4)))
...
table_a6 %>% 
  ...
  left_join(limits, by = "reagent_lot") %>%
  mutate(LoB + c_p * SD_L)
