...
plot_probit <- function(lot) {
  ...
  inv_probit_fn <- function(x) {
    ...
    10^((qnorm(1-alpha) - intercept) / slope)
  }
  ...
  tables_c12 %>%
    ...
    geom_point() +
    scale_x_log10(breaks = c(0.001, 0.01, 0.1, 1), limits = c(0.001, 1), name = "Concentration") +
